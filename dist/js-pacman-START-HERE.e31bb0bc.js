...
var startButton = document.querySelector('#start-button'); //Constantes do Jogo

var POWER_PILL_TIME = 10000; //ms

var GLOBAL_SPEED = 80; //ms

var gameBoard = _GameBoard.default.createGameBoard(gameGrid, _setup.LEVEL); //Configuração Inicial
